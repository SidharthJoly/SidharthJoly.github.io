...
const Linescape = ({ cellSize = 20, proximityRatio = 0.25 }) => {
...
const App = () => {
  return /*#__PURE__*/React.createElement(Linescape, { cellSize: DEFAULT_CELL });
};

ReactDOM.render( /*#__PURE__*/React.createElement(App, null), ROOT_NODE);
